========================================================================
    コンソール アプリケーション: FeatureExtractionApplication プロジェクトの概要
========================================================================

この FeatureExtractionApplication アプリケーションは、AppWizard により作成されました。

このファイルには、FeatureExtractionApplication アプリケーションを構成する各ファイルの内容の概要が含まれています。


FeatureExtractionApplication.vcxproj
...
FeatureExtractionApplication.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    これらのファイルは、FeatureExtractionApplication.pch という名前のプリコンパイル済みヘッダー (PCH) ファイルと、StdAfx.obj という名前のプリコンパイル済みの型ファイルをビルドするために使用されます。
